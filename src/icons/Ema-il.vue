<template>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="email" class="w-10 h-10">
        <rect width="30" height="22" x="1" y="9" fill="#ffc661" rx="3" ry="3"></rect>
        <path fill="#e49f4e"
        ...
        <path fill="#96d7ff"
            d="M28,9H4a3,3,0,0,0-2.71,1.74L15.23,24.68a1.09,1.09,0,0,0,1.54,0L30.71,10.74A3,3,0,0,0,28,9Z"></path>
        <path fill="#ff9797"
        ...
        <path fill="#86c3ef" d="M27.19,9H4.81v5.27L15.23,24.68a1.09,1.09,0,0,0,1.54,0L27.19,14.27Z"></path>
        <path fill="#eef5fd"
            d="M26,4V15.45l-9.23,9.23a1.09,1.09,0,0,1-1.54,0L6,15.45V4A3,3,0,0,1,9,1H23A3,3,0,0,1,26,4Z"></path>
        <path fill="#d7e2f2"
