<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="38" height="38"
        viewBox="0 0 33.867 33.867" id="whatsapp">
        <defs>
            <linearGradient id="a">
                <stop offset="0" stop-color="#00ce4e"></stop>
                <stop offset="1" stop-color="#a7e890"></stop>
            </linearGradient>
            <linearGradient id="c" x1="17.471" x2="17.611" y1="29.43" y2="1.058"
                gradientTransform="translate(-1.459 -.047) scale(1.04447)" gradientUnits="userSpaceOnUse"
                xlink:href="#a"></linearGradient>
            <linearGradient id="d" x1="17.775" x2="18.362" y1="10.861" y2="33.338"
                gradientTransform="translate(-1.052 -1.888) scale(1.06098)" gradientUnits="userSpaceOnUse"
        ...
        <path fill="url(#c)"
            d="M16.936 1.058c-8.767 0-15.873 7.107-15.873 15.873 0 2.882.785 5.71 2.271 8.18l-.85 5.759c-.22 1.41.91 2.103 1.963 1.906l6.436-1.173c1.92.792 3.976 1.2 6.053 1.2 8.766 0 15.872-7.106 15.872-15.872S25.702 1.058 16.936 1.058Z"
